...
public class RightDriveAndDump extends SequentialCommandGroup {
    //constructor for the ComplexAuto command
    public RightDriveAndDump (SwerveSubsystem swerveSubsystem, Arm arm, Intake intake){
